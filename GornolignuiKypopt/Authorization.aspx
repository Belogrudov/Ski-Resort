<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Authorization.aspx.cs" Inherits="GornolignuiKypopt.Authorization" %>
    ...
    <form id="form1" runat="server">
        <div class="auth">
            <div class="container-fluid">
                ...
                <br />
                <a href="Registration.aspx">Зарегистрироваться</a>
            </div>
        </div>
    </form>
</body>
