<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Kategorii.aspx.cs" Inherits="GornolignuiKypopt.Kategorii" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="container-fluid">
            ...
            <asp:GridView ID="gvKategorii" runat="server" AllowSorting="true" CurrentSortDirection="ASC" Font-Size="14px" CssClass="gridView"
                AlternatingRowStyle-Wrap="false" HeaderStyle-HorizontalAlign="Center" OnRowDataBound="gvKategorii_RowDataBound" OnSelectedIndexChanged="gvKategorii_SelectedIndexChanged1" OnSorting="gvKategorii_Sorting" Width="477px">
                <Columns>
